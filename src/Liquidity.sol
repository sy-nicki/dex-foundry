...
contract LiquidityExamples is IERC721Receiver {
    ...
    // Implementing `onERC721Received` so this contract can receive custody of erc721
    ...
    function collectAllFees() external returns (uint256 amount0, uint256 amount1) {
        ...
        // alternatively can set recipient to msg.sender and avoid another transaction to
        // sendToOwner
